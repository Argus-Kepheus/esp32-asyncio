"""Diagnostic 2/13 — First blue LED, toggle-loop blink (GPIO 26).

Same circuit as diagnostic 1, but using the toggle idiom
...
depends on, not just that the GPIO can be driven. See diagnostics/README.md for
