...
This is the standard community driver distributed with MicroPython
firmware images and widely reused across ESP32/Wokwi projects.
...
class SSD1306_I2C(SSD1306):
    def __init__(self, width, height, i2c, addr=0x3C, external_vcc=False):
        ...
        # write_list is passed to i2c.writevto() to save memory
