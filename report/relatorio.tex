...
$^{1}$Nome de arquivo declarado no comentário de \texttt{wokwi.toml}, onde o binário é baixado manualmente e renomeado para \texttt{firmware.bin} antes do uso local. \texttt{SHA-256} do binário efetivamente presente neste repositório: \texttt{\FirmwareSHA{}} -- calculado localmente nesta revisão, não conferido de forma independente contra o servidor de download do MicroPython. Qualquer reprodução futura deve conferir esse hash antes de assumir que obteve exatamente o mesmo \textit{build}.
